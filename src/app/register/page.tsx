    ...
    <div className="w-full max-w-7xl mx-auto px-6 py-24 min-h-[80vh] flex flex-col items-center justify-center">
      <div className="glass-panel p-10 rounded-3xl border-white/10 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-secondary-foreground">Join Snopiz for premium assets</p>
        </div>
        ...
        >
          ...
          <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-white rounded-xl h-12 text-md hover-glow mt-4">
            Create Account
          </Button>
        </form>
        ...
        <p className="text-center text-sm text-secondary-foreground mt-8">
          Already have an account? <Link href="/login" className="text-primary hover:text-accent font-medium transition-colors">Sign In</Link>
        </p>
      </div>
    </div>
  )
