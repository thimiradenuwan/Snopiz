          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold tracking-tight mb-2">
                Create an <span className="bg-gradient-to-r from-primary to-cyan-400 bg-clip-text text-transparent">Account</span>
              </h1>
              <p className="text-secondary-foreground text-sm">Join Snopiz today to start exploring</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-secondary-foreground group-focus-within:text-primary transition-colors z-10" />
                <input 
                  type="text" 
                  name="name"
                  required
                ...
                />
                <label className="absolute left-12 top-4 text-secondary-foreground text-sm transition-all peer-focus:-translate-y-2.5 peer-focus:text-[10px] peer-focus:text-primary peer-valid:-translate-y-2.5 peer-valid:text-[10px] pointer-events-none">Full Name</label>
              </div>
