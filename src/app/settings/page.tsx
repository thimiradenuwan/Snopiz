    ...
    <div className="flex flex-col items-center w-full min-h-screen pt-24 pb-32">
      <div className="w-full max-w-4xl px-6">
        ...
        >
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground mb-4">Account Settings</h1>
          <p className="text-secondary-foreground text-lg mb-8 max-w-xl mx-auto">
            Configure your preferences, notifications, and application settings. This section is currently under construction.
          </p>
        </motion.div>
      </div>
    </div>
