  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative overflow-hidden rounded-[2rem] glass-panel px-7 py-6">
        ...
        <div className="relative flex items-center gap-5">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-bold text-foreground tracking-tight leading-tight">Snopiz User</h2>
            <p className="text-sm text-secondary-foreground mt-0.5">Premium Member</p>
          </div>
      ...
      <div className="glass-panel rounded-[2rem] overflow-hidden">
        ...
        {[
          { label: "Email",    value: "Not set",        hasAction: true },
          { label: "Username", value: "snopiz_user",    hasAction: false },
          { label: "Role",     value: "Premium Member", hasAction: false },
          { label: "Joined",   value: "July 2026",      hasAction: false },
        ].map((item, i, arr) => (
          <div key={item.label}>
            ...
            <div className="glass-panel rounded-[2rem] overflow-hidden h-full flex flex-col">
              ...
              <div className="flex items-center gap-3 px-4 py-3.5 border-b border-border/30">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-foreground truncate">Snopiz User</p>
                  <p className="text-[10px] text-secondary-foreground">Premium</p>
                </div>
              </div>
